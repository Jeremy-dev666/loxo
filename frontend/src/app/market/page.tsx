...
function OfficialAdoptModal({ onClose, onDone }: { onClose: () => void; onDone: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-pixel-black/70 p-4">
      <form onSubmit={submit} className="w-full max-w-sm space-y-4 border border-pixel-line bg-pixel-white shadow-pixel p-6">
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
        {listings.map((listing) => (
          <div key={listing.id} className="border border-pixel-line bg-pixel-white shadow-pixel p-4">
...
function ApiAgentsTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
        {presets.map((preset) => (
          <div key={preset.id} className="border border-pixel-line bg-pixel-white shadow-pixel p-4">
            <div className="flex items-center gap-2">
...
function TemplateAdoptModal({
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-pixel-black/70 p-4">
      <form
        onSubmit={submit}
        className="max-h-[85vh] w-full max-w-lg space-y-4 overflow-y-auto border border-pixel-line bg-pixel-white shadow-pixel p-6"
      >
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
        {templates.map((template) => (
          <div key={template.id} className="border border-pixel-line bg-pixel-white shadow-pixel p-4">
            <div className="flex items-center gap-2">
...
function MarketPageInner() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-1 border-b border-pixel-line text-sm">
        {TABS.map((t) => (
          <button
            key={t.id}
            onClick={() => setTab(t.id)}
