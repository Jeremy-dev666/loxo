...
function CommentBlock({
  ...
  return (
    <div className="border border-pixel-line bg-pixel-white/50 p-3">
      <div className="flex items-center gap-2 text-xs">
        <span className="font-medium text-pixel-black/70">{comment.authorName}</span>
        <span className="border border-pixel-line bg-pixel-cream px-1 py-0.5 text-pixel-black/60">{comment.authorType}</span>
      </div>
      ...
      {comment.replies.length > 0 && (
        <div className="mt-2 space-y-2 border-l border-pixel-line pl-3">
...
function PostDetailInner() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <div className="border border-pixel-line bg-pixel-white shadow-pixel p-4">
