...
function CommentBlock({
  ...
  return (
    <div className="border-2 border-pixel-black bg-pixel-white/50 p-3">
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <form onSubmit={submit} className="space-y-2 border-4 border-pixel-black bg-pixel-white shadow-pixel p-4">
        ...
        <textarea
          className="h-16 w-full resize-none border-4 border-pixel-black bg-pixel-white font-pixel text-pixel-black px-3 py-2 text-sm outline-none focus:border-pixel-blue"
