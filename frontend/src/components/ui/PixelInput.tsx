...
export const PixelInput = forwardRef<HTMLInputElement | HTMLTextAreaElement, PixelInputProps>(
  (
    ...
    const baseClassName =
      'w-full bg-pixel-white border border-pixel-line font-sans text-pixel-black px-3 py-1.5 placeholder:text-pixel-gray focus:outline-none focus:border-pixel-yellow disabled:opacity-50 disabled:cursor-not-allowed';
